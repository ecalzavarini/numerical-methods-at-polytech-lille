...
graphique.
    ...
    \paragraph{Rappel de Python}\label{rappel-de-python}
...
{\color{incolor}In [{\color{incolor} }]:} \PY{k+kn}{import} \PY{n+nn}{numpy} \PY{k+kn}{as} \PY{n+nn}{np}
        ...
        \PY{c}{\PYZsh{} lecture de la matrice A, p.ex. [[1,2],[3,4]]}
        \PY{n}{A}\PY{o}{=}\PY{n+nb}{input}\PY{p}{(}\PY{l+s}{\PYZdq{}}\PY{l+s}{A=?}\PY{l+s}{\PYZdq{}}\PY{p}{)} 
        \PY{c}{\PYZsh{} lecture du vecteur b, p.ex. [0,1]}
        \PY{n}{b}\PY{o}{=}\PY{n+nb}{input}\PY{p}{(}\PY{l+s}{\PYZdq{}}\PY{l+s}{b=?}\PY{l+s}{\PYZdq{}}\PY{p}{)} 
        ...
        \PY{c}{\PYZsh{} on ajoute b comme dernière colonne à A }
        \PY{c}{\PYZsh{} pour obtenir la matrice augmentée Ab}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor} }]:} \PY{c}{\PYZsh{} produit scalaire matrice vecteur  ( c\PYZsq{}est différent de A*b! )}
        \PY{n}{np}\PY{o}{.}\PY{n}{dot}\PY{p}{(}\PY{n}{A}\PY{p}{,}\PY{n}{b}\PY{p}{)} 
        \PY{c}{\PYZsh{} somme des composantes du vecteur b}
